...
local progressMat
local getImgur = gKarts.GetImgur
...
gKarts.DrawProgressWheel = drawProgressWheel

do
    local materials = {}
    local grabbingMaterials = {}

    function gKarts.DrawImgur(x, y, w, h, imgurId, col)
    ...
    function gKarts.DrawImgurRotated(x, y, w, h, rot, imgurId, col)
        if not materials[imgurId] then
